...
app.use("/api/zone-deadline", require("./routes/zoneDeadlineRoute"));
app.use("/api/player-stories", require("./routes/playerStoryRoute"));
app.use("/api/registration-faqs", require("./routes/registrationFaqRoute"));
app.use("/api/registration-hero", require("./routes/registrationHeroRoute"));
app.use("/api/registration-banner", require("./routes/registrationBannerRoute"));
