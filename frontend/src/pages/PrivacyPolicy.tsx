                ...
                <div className="p-8 md:p-12 rounded-3xl shadow-lg border border-gray-100 bg-white">
                    ...
                    <div className="mt-12 space-y-10">
                        ...
                        <section>
                            ...
                            <p className="text-slate-600 mb-2 leading-relaxed text-[1.05rem]">We may update or modify this Privacy Policy periodically. Any changes will be reflected with a revised "<span className="font-bold">Last Updated</span>" date at the top of this page.</p>
